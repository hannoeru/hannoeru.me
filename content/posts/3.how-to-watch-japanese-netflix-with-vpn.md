...
> **更新（2026）：** Netflix 自 2021 年起大幅加強對 VPN／代理流量的封鎖，本文使用的 VPN Gate 公開伺服器 IP 現在大多已被偵測，成功率遠低於 2019 年。另外，跨區觀看違反 Netflix 服務條款，帳號有被限制的風險，請自行評估。
...
這個網站上面提供了許多學術用途或是自行架設的 VPN 伺服器可以供大家使用。（※ 2019 年當時公開 IP 較難被封鎖，但現在大部分已被 Netflix 偵測，成功率不高。）
...
回到 [VPN Gate](https://www.vpngate.net/ja/) 的首頁，往下拉你會發現有一整排的列表。
...
![wp-image-51](/images/2019/04/screenshot-2019-04-30-2.45.53-min-1.png)

點進去以後會看到兩個分類

![wp-image-53](/images/2019/04/screenshot-2019-04-30-2.49.33-min-1.png)
...
![wp-image-54](/images/2019/04/screenshot-2019-04-30-2.57.41.png)

Windows 的 OpenVPN GUI 安裝完成後會自動套用設定檔中的 `redirect-gateway`，因此所有流量都會導入 VPN，不用多做設定。

完成之後按下『連結』，就可以開始享受日本Netflix了！！

### 測試

進入 [ipinfo.io](https://ipinfo.io) 查看自己目前的 IP 位置。
