...
image: /images/2020/03/screenshot-2020-03-06-2.59.20.png
categories:
  - Linux
tags:
  - Admin
...
> **重要：** Linode（現為 Akamai Cloud Computing Services）與大多數雲端服務商預設封鎖對外 port 25。安裝前請先向服務商申請解封，否則郵件無法寄出。
...
![wp-image-532](/images/2020/03/screenshot-2020-03-06-2.08.53.png)
...
> **更新（2026）：** Docker Compose V1 已於 2023 年停止支援。現在的安裝方式是使用 Docker 官方 repository 的 `docker-compose-plugin` 套件，指令為 `docker compose`（中間沒有 `-`）。目前 Mailu 版本為 3.x，設定介面與本文的畫面可能略有不同。
...
![wp-image-538](/images/2020/03/screenshot-2020-03-06-2.24.47.png)
![wp-image-535](/images/2020/03/screenshot-2020-03-06-2.25.59.png)
![wp-image-537](/images/2020/03/screenshot-2020-03-06-2.26.10.png)

替換 server-ip 為你的 Linode IP（虛擬機IP）

![wp-image-536](/images/2020/03/screenshot-2020-03-06-2.26.35.png)
![wp-image-534](/images/2020/03/screenshot-2020-03-06-2.26.43.png)

最後點選 Setup Mailu 就會秀出這樣的頁面：

![wp-image-539](/images/2020/03/screenshot-2020-03-06-2.34.08.png)
...
# 替換 PASSWORD => 管理員密碼（新版的 Mailu 安裝精靈會直接建立管理員帳號）
docker compose -p mailu exec admin flask mailu admin admin domain.com PASSWORD
```
...
除了 A 紀錄之外，郵件伺服器還需要以下 DNS 紀錄（詳細值可在管理界面確認）：

- `MX`：指向 `mail.domain.com`
...
進去 Mail Domains 點選第一個 Icon

![wp-image-540](/images/2020/03/screenshot_2020-03-06_2_45_03.png)
