...
function getRandomNumber(data) {
  // 注意：這裡的 this 是 Vue 2 元件的 methods 綁定，
  // 單獨複製這段到其他專案時要自行傳入 generateIndex。
...
[1]: https://gh.hannoeru.me/lucky-wheel/
[2]: https://github.com/hannoeru/lucky-wheel
[3]: https://github.com/axios/axios
[4]: https://v2.vuejs.org/v2/guide/list.html # 本作品使用 Vue 2（已於 2023 年終止支援）
[5]: https://v2.vuejs.org/v2/guide/instance.html
[6]: https://v2.vuejs.org/v2/api/#Vue-set
