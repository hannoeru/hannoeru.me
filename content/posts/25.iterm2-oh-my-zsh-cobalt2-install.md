...
image: /images/2020/02/screenshot-2020-02-22-14.31.19.png
categories:
  - MacOS
tags:
  - Cobalt2
...
> **更新：** macOS Catalina（2019）以上已内建 zsh 作為預設 Shell，不需要另外安裝或執行 `chsh`。以下段落僅供舊系統參考。

如果不是使用 ＭacOS Catalina 的話，要手動安裝 Zsh 到電腦上。
...
出現 `/bin/zsh` 代表已經成功切換為 Zsh 了（切換後要開新終端機視窗才會生效）
...
> **更新：** powerline/fonts 儲存庫已於 2022 年封存。建議改用 Nerd Font（Cobalt2 官方 README 目前也推薦 Nerd Font）：

```bash
brew install --cask font-fira-code-nerd-font
```

（原始做法，powerline fonts）：
...
打開 iTerm2 設定，快速鍵 cmd + ,

### 更改顏色

到 Profiles >> Default >> Colors >> Color Presets 下拉選單

![wp-image-514](/images/2020/02/screenshot-2020-02-22-14.16.48.png)
...
到旁邊的 Text 下方的 Font，搜尋「Nerd」（或舊字型「powerline」）選擇自己喜歡的字型就可以了

![wp-image-513](/images/2020/02/screenshot-2020-02-22-14.24.45.png)

## 完成

這是我目前使用的樣式

![wp-image-518](/images/2020/02/screenshot-2020-02-22-14.31.19.png)

[下載設定檔](/data/iterm2-profile.json){download}
